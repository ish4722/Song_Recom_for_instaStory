...
TEXT_WEIGHT = float(os.getenv("TEXT_WEIGHT", "0.48"))
IMAGE_WEIGHT = float(os.getenv("IMAGE_WEIGHT", "0.32"))
MOOD_WEIGHT = float(os.getenv("MOOD_WEIGHT", "0.12"))
PREFERENCE_WEIGHT = float(os.getenv("PREFERENCE_WEIGHT", "0.08"))
