...
def process_image(image_file, manual_description=None):
    """Generate a detailed image description using cached BLIP and optional Gemini refinement."""
    ...
    gemini_model = genai.GenerativeModel(
        ...
        system_instruction=("Analyze visual content for a music recommendation system. Return one rich, unified "
